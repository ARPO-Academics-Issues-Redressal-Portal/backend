...
INSERT INTO `announcement` VALUES (1000000,'Announcement_1','This is first announcement',456,'CS253A','2022-03-24 18:46:49');
...
CREATE TABLE `course_role` (
  ...
  PRIMARY KEY (`uuid`)
) ENGINE=InnoDB AUTO_INCREMENT=2000016 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `course_role` VALUES (2000000,'CS253A',123,'Student'),(2000001,'CS220A',123,'Student'),(2000002,'CS220A',234,'Student'),(2000003,'CS253A',345,'Student'),(2000004,'CS253A',456,'Instructor'),(2000005,'CS220A',567,'Instructor'),(2000006,'CS253A',678,'TA'),(2000007,NULL,789,'Admin'),(2000010,'sample_course',123,'sample_role'),(2000011,'sample_course',456,'sample_role'),(2000012,'sample_course',456,'sample_role'),(2000015,'sample_course',456,'sample_role');
...
INSERT INTO `forum` VALUES (3000000,'First Forum',123,'This is a forum',10,'CS253A','isaha@iitk.ac.in',1,'2022-03-24 13:19:34');
...
INSERT INTO `forum_response` VALUES (4000000,3000000,'isaha@iitk.ac.in','This is a reply to the forum','CS253A',10,0,'2022-03-24 13:23:00','akshan@iitk.ac.in');
...
INSERT INTO `notification` VALUES (5000000,'Dummy notification','This is notification to you','akshan@iitk.ac.in');
...
INSERT INTO `other_query` VALUES (6000000,'Other query test',123,'This is an other query','W','isaha@iitk.ac.in','2022-03-24 13:28:08','Course Acceptance');
...
CREATE TABLE `private_query` (
  ...
  `category` varchar(45) NOT NULL,
  PRIMARY KEY (`uuid`)
) ENGINE=InnoDB AUTO_INCREMENT=8000001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `private_query` VALUES (8000000,'Private query test',123,'This is a private query','CS253A','W','isaha@iitk.ac.in','2022-03-24 13:32:26','Logistics');
...
-- Dump completed on 2022-03-26 12:48:15
